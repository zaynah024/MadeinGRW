			...
			<div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 my-10 gap-6 sm:gap-8 md:gap-10">
				{sectors.slice(0, 8).map((sector, index) => (
					...
					>
						...
						<a href="/sectordetail">
							<span className="p-2 px-3 rounded-full absolute right-2 top-2 -rotate-45 bg-[#FCD900] w-12 h-12 flex items-center justify-center transform transition-all duration-300 ease-out hover:scale-110 hover:shadow-lg z-30">
						...
						/>
						{/* Title */}
						<p className="text-white text-lg absolute bottom-2 left-8 z-20 font-semibold drop-shadow-lg">
							{sector.title}
						</p>
					</div>
				))}
