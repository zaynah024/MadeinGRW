      ...
      <div className="flex flex-col gap-6 md:flex-row my-10">
        ...
        <div className="text-gray-600 w-full transform transition-all duration-500 ease-out animate-fade-in-up" style={{ animationDelay: '200ms' }}>
          ...
          {showMore && (
            <div>
              <p className="mb-4">
                Gujranwala Business Center serves as a key hub for trade, manufacturing, and enterprise. It brings together some of the city's leading industries — from stainless steel and ceramics to furniture and export goods — under one vibrant ecosystem. With modern facilities and deep-rooted business networks, the center plays a vital role in connecting local manufacturers with national and international markets.
              </p>
              <p className="mb-4">
          ...
          <div className="flex mt-6 items-center transform transition-all duration-500 ease-out animate-fade-in-up" style={{ animationDelay: '400ms' }}>
            ...
            >
              ...
              <FaArrowRight className={`transform transition-transform duration-300 ${showMore ? 'rotate-90' : 'rotate-0'} group-hover:translate-x-1`} />
            </button>
          </div>
        </div>
